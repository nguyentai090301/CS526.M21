  ...
  return (
    <View style={{flex: 1,backgroundColor:'#EDE3AF'}}>
        ...
        <FlatList
          data={
            [ 
              {key:'1',heading:'Thịt kho tiêu đơn giản',img1:'../resources/Icon3.png',namecook:'Lâm Võ',heading1:'Thịt ba rọi, Gia vị: đường, muối tiêu, hạt nêm, nước màu, nước mắm ',img2:'../resources/ThitHeo1.png'},
              {key:'2',heading:'Thịt kho tiêu đơn giản',img1:'../resources/Icon3.png',namecook:'Lâm Võ',heading1:'Thịt ba rọi, Gia vị: đường, muối tiêu, hạt nêm, nước màu, nước mắm ',img2:'../resources/ThitHeo1.png'},
              {key:'3',heading:'Thịt kho tiêu đơn giản',img1:'../resources/Icon3.png',namecook:'Lâm Võ',heading1:'Thịt ba rọi, Gia vị: đường, muối tiêu, hạt nêm, nước màu, nước mắm ',img2:'../resources/ThitHeo1.png'},
              {key:'4',heading:'Thịt kho tiêu đơn giản',img1:'../resources/Icon3.png',namecook:'Lâm Võ',heading1:'Thịt ba rọi, Gia vị: đường, muối tiêu, hạt nêm, nước màu, nước mắm ',img2:'../resources/ThitHeo1.png'},
            ]
          }
           renderItem={({item}) =>    
            <View style={{backgroundColor:'white',marginHorizontal:10,marginTop:20,height:430,borderRadius:15}}>
                    ...
                    <View style={{flexDirection:'row'}}>
                        ...
                        >
                          <Image source ={require('../resources/ThitBaChi.png')}  style = {{height:200, width: 150,marginTop:20,marginLeft:25,borderRadius:20}}></Image>
                        </TouchableOpacity>
                        </View>
                    </View> 
            </View>
